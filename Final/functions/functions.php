<?php 
$con = mysqli_connect("localhost","root","","ecommerce_books");
...
function cart(){
	...
	if(isset($_GET['add_cart'])){
		...
		if(mysqli_num_rows($run_check_pro) > 0){
     	   ...
     	   $run_insert_pro = mysqli_query(
				$con, "insert into cart (product_id,product_title,ip_address) values (
					'$product_id','$pro_title','$ip') ");
